...
public class PlayerAttack : MonoBehaviour {
    ...
    [SerializeField] private GameObject attackArea; // This is the collider that determines the area where the player does damage with their attack
    private bool isAttacking = false;               // This allows the player to deal damage in an area for a given time

    private float attackTime = 0.25f;               // This keeps track of how long the players damage area should stay attack, by having it take a bit of time to go away,
                                                    // the attack timing becomes more lenient
    private float timer = 0f;                       // This timer keeps track of how much time has passed since the player started attacking
